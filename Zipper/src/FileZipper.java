...
public class FileZipper extends JFrame {
    public FileZipper() {
        ...
        Action akcjaUsuwania = new Akcja("Usuń", "Usuń zaznaczony/zznaczone wpisy z archiwum", "Ctrl+U", new ImageIcon("usun.png"));
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup()
                        ...
                        .addGroup(layout.createSequentialGroup().addComponent(bDodaj).addComponent(bUsun).addGap(5, 50, Short.MAX_VALUE).addComponent(bZip))
        );
